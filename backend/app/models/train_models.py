...
# Ajusta el nombre de la columna objetivo según tu CSV
...
with open(os.path.join(DATA_DIR, "diabetes_model.pkl"), "wb") as f:
...
# Ajustar columnas
# Convertimos categóricas a numéricas según notebook
